...
class YOLO(object):
    ...
    # def generate2(self):
    #     model_path = os.path.expanduser(self.model_path2)
    #     assert model_path.endswith('.h5'), 'Keras model or weights must be a .h5 file.'
        
    #     self.model2 = yolo_body([None, None, 3], self.anchors_mask, self.num_classes, self.phi)
    ...
    #     #---------------------------------------------------------#
    #     self.input_image_shape = Input([2,],batch_size=1)
    #     inputs  = [*self.model2.output, self.input_image_shape]
    #     outputs = Lambda(
    #         DecodeBox, 
    #         output_shape = (1,), 
    #         name = 'yolo_eval',
    ...
    #          }
    #     )(inputs)
    #     self.yolo_model2 = Model([self.model2.input, self.input_image_shape], outputs)
    ...
    def get_pred(self, image_data, input_image_shape):
        ...
        # out_boxes2, out_scores2, out_classes2 = self.yolo_model2([image_data, input_image_shape], training=False)
        return outs
    #---------------------------------------------------#
    #   检测图片
    #---------------------------------------------------#
