...
def DecodeBox(outputs,
    ...
    for c in range(num_classes):
        ...
        #   保留一定区域内得分最大的框
        #-----------------------------------------------------------#
        #   max_boxes_tensor = 100, nms_iou = 0.3
        nms_index = tf.image.non_max_suppression(class_boxes, class_box_scores, max_boxes_tensor, iou_threshold=nms_iou)
        #-----------------------------------------------------------#
        #   获取非极大抑制后的结果
        #   下列三个分别是：框的位置，得分与种类
        #-----------------------------------------------------------#
        # print("class_boxes in utils:")
        # print(class_boxes)
        # print("class_box_score in utils")
        # print(class_box_scores)
        class_boxes         = K.gather(class_boxes, nms_index)
        class_box_scores    = K.gather(class_box_scores, nms_index)
        classes             = K.ones_like(class_box_scores, 'int32') * c
        # print("class_boxes in utils after gather:")
        # print(class_boxes)
        # print("class_box_score in utils after gather")
        # print(class_box_scores)
        # print("classes in utils after gather")
        # print(classes)
    ...
    # print("boxes_out in utils after gather:")
    # print(boxes_out)
    # print("scores_out in utils after gather")
    # print(scores_out)
    # print("classes_out in utils after gather")
    # print(classes_out)
